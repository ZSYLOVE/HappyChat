...
import 'dart:io' show Directory, InternetAddress, PathSetting, SocketException, join;
  ...
  Future<void> _checkCameraPermission() async {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        width: MediaQuery.of(context).size.width, // 设置宽度与屏幕一致
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                SizedBox(
                  width: MediaQuery.of(context).size.width * 0.4, // 设置按钮宽度
                  child: _buildProfileButton(Icons.lock_outlined, '修改密码', () {
                ...
                SizedBox(
                  width: MediaQuery.of(context).size.width * 0.4, // 设置按钮宽度
                  child: _buildProfileButton(Icons.tag_faces_outlined, '修改头像', () {
                    Navigator.pop(context);
                    _UpdtaeAvatar();
                  }),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width * 0.4, // 设置按钮宽度
                  child: _buildProfileButton(Icons.fingerprint, '指纹验证', () {
                    Navigator.pop(context);
                    _askForFingerprint();
                  }),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width * 0.4, // 设置按钮宽度
                  child: _buildProfileButton(Icons.exit_to_app, '退出登录', _handleLogout),
                ),
              ],
            ),
          ],
